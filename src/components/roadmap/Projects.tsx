  ...
  return (
    <>
      ...
      <p>
        ...
        <a href="https://github.com">GitHub</a> is free and is great for this,
        and{" "}
      ...
      <p>
        ...
        <a href="https://www.codecademy.com">Codecademy</a> has free courses on
        the basics of most languages to get you started. The language you choose
        should be based on what project you want to complete. Below are a couple
        of examples.
      </p>
      <br />
      <h3>
      ...
      <p>
        ...
        <a href="https://www.youtube.com/watch?v=MCLiPW2ns2w">
          video walkthrough
        </a>{" "}
      ...
      <p>
        ...
        create a starting screen where the user can select a difficulty level of
        AI opponent (after you've fully implemented everything shown in the
      ...
      <p>
        ...
        has a{" "}
        <a href="https://www.youtube.com/watch?v=A7CGcFjQQtQ&t=633s">
          video walkthrough
        </a>{" "}
      ...
      <p>
        ...
        <a href="https://www.youtube.com/watch?v=qz0aGYrrlhU&list=PLijBK_3oP_H6MG6lU_8TZ5Q2DhXsKKGJ1&index=1&t=1895s">
          HTML tutorial
        </a>{" "}
        of HTML. You can then follow a long with this quick Web Dev Simplified{" "}
        <a href="https://www.youtube.com/watch?v=1PnVor36_40&list=PLijBK_3oP_H6MG6lU_8TZ5Q2DhXsKKGJ1&index=4">
          CSS tutorial
        </a>
        . JavaScript or TypeScript (I recommend TypeScript) can be learned for
        free on <a href="https://www.codecademy.com">Codecademy</a>.
      </p>
      <p>
        After familiarizing yourself with HTML, CSS, and JavaScript/TypeScript,
        you can follow along with Programming with Mosh's{" "}
        <a href="https://www.youtube.com/watch?v=SqcY0GlETPk&list=PLijBK_3oP_H6MG6lU_8TZ5Q2DhXsKKGJ1&index=2&t=809s">
          React tutorial
        </a>
        .
      </p>
      ...
      <p>
        ...
        <a href="https://www.youtube.com/watch?v=Vlolidaoiak&list=PLjcN1EyupaQnvpv61iriF8Ax9dKra-MhZ">
          full series
        </a>{" "}
      ...
      <p>
        ...
        <a href="https://www.youtube.com/watch?v=j48LtUkZRjU&list=PLPV2KyIb3jR5QFsefuO2RlAgWEz6EvVi6">
          full series
        </a>{" "}
      ...
      <p>
        Hilze Vonck has a{" "}
        <a href="https://www.youtube.com/watch?v=axIgxBQVBg0&list=PL21OsoBLPpMOO6zyVlxZ4S4hwkY_SLRW9">
          full series
        </a>{" "}
